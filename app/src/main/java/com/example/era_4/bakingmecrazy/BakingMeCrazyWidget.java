...
public class BakingMeCrazyWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        CharSequence widgetText = BakingMeCrazyWidgetConfigureActivity.loadTitlePref(context, appWidgetId);
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            BakingMeCrazyWidgetConfigureActivity.deleteTitlePref(context, appWidgetId);
        }
    }
